...
// SignString expects data to be base64 encoded
...
// VerifySignatureString expects data and sig to be base64 encoded
func VerifySignatureString(key ed25519.PublicKey, data string, sig string) bool {
	...
	return VerifySignature(key, d, s)
}
